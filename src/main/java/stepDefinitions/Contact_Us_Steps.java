...
public class Contact_Us_Steps {
    ...
    public void i_enter_a_first_name() throws InterruptedException {
        driver.findElement(By.cssSelector("[name=\"first_name\"]")).sendKeys("Grisel");
        Thread.sleep(3000);
    }
    @And("I enter a last name")
    public void i_enter_a_last_name() throws InterruptedException {
        driver.findElement(By.cssSelector("[name=\"last_name\"]")).sendKeys("Gonzalez");
        Thread.sleep(3000);
    }
    @And("I enter an email address")
    public void i_enter_an_email_address()  {
        driver.findElement(By.name("email")).sendKeys("fggonzalez1986@gmail.com");
    }
    @And("I enter a comment")
    public void i_enter_a_comment() {
            driver.findElement(By.name("message")).sendKeys("\"This is an automation Test \"");
        }
